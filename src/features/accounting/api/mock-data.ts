...
export const mockAccounts: Account[] = [
  { id: "acc-assets", name: "Assets", code: "1000", type: "asset", parentId: null, status: "active" },
  { id: "acc-cash", name: "Cash", code: "1100", type: "asset", parentId: "acc-assets", status: "active" },
  { id: "acc-bank", name: "Bank", code: "1200", type: "asset", parentId: "acc-assets", status: "active" },
  { id: "acc-inventory", name: "Inventory", code: "1300", type: "asset", parentId: "acc-assets", status: "active" },
  { id: "acc-liabilities", name: "Liabilities", code: "2000", type: "liability", parentId: null, status: "active" },
  { id: "acc-payable", name: "Supplier Payable", code: "2100", type: "liability", parentId: "acc-liabilities", status: "active" },
  { id: "acc-equity", name: "Equity", code: "3000", type: "equity", parentId: null, status: "active" },
  { id: "acc-capital", name: "Owner's Capital", code: "3100", type: "equity", parentId: "acc-equity", status: "active" },
  { id: "acc-income", name: "Income", code: "4000", type: "income", parentId: null, status: "active" },
  { id: "acc-sales", name: "Sales Revenue", code: "4100", type: "income", parentId: "acc-income", status: "active" },
  { id: "acc-expenses", name: "Expenses", code: "5000", type: "expense", parentId: null, status: "active" },
  { id: "acc-purchase-cost", name: "Purchase Cost", code: "5100", type: "expense", parentId: "acc-expenses", status: "active" },
  { id: "acc-salary", name: "Salary", code: "5200", type: "expense", parentId: "acc-expenses", status: "active" },
  { id: "acc-operating", name: "Operating Expense", code: "5300", type: "expense", parentId: "acc-expenses", status: "active" },
]
...
export const mockLedgerEntries: LedgerEntry[] = [
  { id: "gl-1", date: daysAgo(1), reference: "JE-2026-0101", accountId: "acc-cash", accountName: "Cash", debit: 136.88, credit: 0, user: "Accountant" },
  { id: "gl-2", date: daysAgo(1), reference: "JE-2026-0101", accountId: "acc-sales", accountName: "Sales Revenue", debit: 0, credit: 136.88, user: "Accountant" },
  { id: "gl-3", date: daysAgo(2), reference: "JE-2026-0102", accountId: "acc-inventory", accountName: "Inventory", debit: 4120, credit: 0, user: "Accountant" },
  { id: "gl-4", date: daysAgo(2), reference: "JE-2026-0102", accountId: "acc-payable", accountName: "Supplier Payable", debit: 0, credit: 4120, user: "Accountant" },
  { id: "gl-5", date: daysAgo(5), reference: "PMT-2026-0071", accountId: "acc-bank", accountName: "Bank", debit: 0, credit: 2000, user: "Finance Manager" },
  { id: "gl-6", date: daysAgo(5), reference: "PMT-2026-0071", accountId: "acc-payable", accountName: "Supplier Payable", debit: 2000, credit: 0, user: "Finance Manager" },
  { id: "gl-7", date: daysAgo(9), reference: "SINV-2026-1195", accountId: "acc-cash", accountName: "Cash", debit: 108, credit: 0, user: "Cashier" },
  { id: "gl-8", date: daysAgo(9), reference: "SINV-2026-1195", accountId: "acc-sales", accountName: "Sales Revenue", debit: 0, credit: 108, user: "Cashier" },
]
...
export const mockAuditEntries: AuditEntry[] = [
  { entityId: "je-104", entityType: "JOURNAL_ENTRY", action: "CREATED", referenceNumber: "JE-2026-0104", performedBy: "Accountant", timestamp: daysAgo(0) },
  { entityId: "je-103", entityType: "JOURNAL_ENTRY", action: "POSTED", referenceNumber: "JE-2026-0103", performedBy: "Finance Manager", timestamp: daysAgo(0) },
  { entityId: "pmt-74", entityType: "PAYMENT", action: "CREATED", referenceNumber: "PMT-2026-0074", performedBy: "Accountant", timestamp: daysAgo(0) },
  { entityId: "so-213", entityType: "SALE", action: "CONFIRMED", referenceNumber: "SO-2026-0213", performedBy: "Store Manager", timestamp: daysAgo(1) },
  { entityId: "je-102", entityType: "JOURNAL_ENTRY", action: "POSTED", referenceNumber: "JE-2026-0102", performedBy: "Finance Manager", timestamp: daysAgo(2) },
  { entityId: "po-211", entityType: "PURCHASE_ORDER", action: "CONFIRMED", referenceNumber: "PO-2026-0211", performedBy: "Finance Manager", timestamp: daysAgo(3) },
  { entityId: "pmt-71", entityType: "PAYMENT", action: "CREATED", referenceNumber: "PMT-2026-0071", performedBy: "Finance Manager", timestamp: daysAgo(5) },
]
